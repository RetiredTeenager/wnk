...
import net.aot.mytitan.procedures.ParticlesAttackTitanProcedure;
import net.aot.mytitan.procedures.AttackRideProcedure;
...
public class EntityControllableAttackTitanEntity extends MyTitanModElements.ModElement {
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire().size(5f, 15f))
	...
	public void registerModels(ModelRegistryEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			return new MobRenderer(renderManager, new Modelbeast_titan(), 5f) {
				@Override
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("my_titan:textures/attacktitan.png");
				}
			};
		});
	}
	public static class CustomEntity extends MonsterEntity implements IAnimatedEntity {
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				ParticlesAttackTitanProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public void onCollideWithPlayer(PlayerEntity sourceentity) {
			...
			double z = this.getPosZ();
			{
				...
				AttackRideProcedure.executeProcedure($_dependencies);
			}
		}
