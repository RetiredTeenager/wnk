...
package net.aot.mytitan.particle;
...
public class ParticleTransformationParticle extends MyTitanModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(false);
	public ParticleTransformationParticle(MyTitanModElements instance) {
		super(instance, 87);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("particle_transformation"));
	}
