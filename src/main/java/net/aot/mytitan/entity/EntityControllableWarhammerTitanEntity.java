...
public class EntityControllableWarhammerTitanEntity extends MyTitanModElements.ModElement {
	public static EntityType entity = null;
	public EntityControllableWarhammerTitanEntity(MyTitanModElements instance) {
		super(instance, 22);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.8f))
						.build("entity_controllable_warhammer_titan").setRegistryName("entity_controllable_warhammer_titan");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -3355444, -1, new Item.Properties().group(CreativeTabMyTitanItemGroup.tab))
				.setRegistryName("entity_controllable_warhammer_titan_spawn_egg"));
	}
