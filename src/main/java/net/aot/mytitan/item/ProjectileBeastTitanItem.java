...
import net.aot.mytitan.procedures.ProjectileBeastTitanWhileBulletFlyingTickProcedure;
import net.aot.mytitan.procedures.ProjectileBeastTitanBulletHitsBlockProcedure;
...
public class ProjectileBeastTitanItem extends MyTitanModElements.ModElement {
	@ObjectHolder("my_titan:projectile_beast_titan")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("entitybulletprojectile_beast_titan").setRegistryName("entitybulletprojectile_beast_titan");
	public ProjectileBeastTitanItem(MyTitanModElements instance) {
		super(instance, 33);
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("projectile_beast_titan");
		}
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, LivingEntity entityLiving, int timeLeft) {
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ArrowCustomEntity entityarrow = shoot(world, entity, random, 2f, 20, 25);
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public void onCollideWithPlayer(PlayerEntity entity) {
			...
			World world = this.world;
			{
				...
				ProjectileBeastTitanBulletHitsBlockProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public void tick() {
			...
			Entity entity = this.getShooter();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				ProjectileBeastTitanWhileBulletFlyingTickProcedure.executeProcedure($_dependencies);
			}
			if (this.inGround) {
				{
					Map<String, Object> $_dependencies = new HashMap<>();
	...
	public static class CustomRender extends EntityRenderer<ArrowCustomEntity> {
		private static final ResourceLocation texture = new ResourceLocation("my_titan:textures/rocksbeasttitanthrowable.png");
