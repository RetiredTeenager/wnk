...
import net.aot.mytitan.procedures.EntityControllableCartTitanRightClickedOnEntityProcedure;
import net.aot.mytitan.procedures.EntityControllableCartTitanOnEntityTickUpdateProcedure;
import net.aot.mytitan.procedures.CartRideProcedure;
import net.aot.mytitan.itemgroup.CreativeTabMyTitanItemGroup;
import net.aot.mytitan.gui.CartTitanGUIGui;
...
public class EntityControllableCartTitanEntity extends MyTitanModElements.ModElement {
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire().size(5f, 3f))
						.build("entity_controllable_cart_titan").setRegistryName("entity_controllable_cart_titan");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -16777012, -256, new Item.Properties().group(CreativeTabMyTitanItemGroup.tab))
	...
	public void registerModels(ModelRegistryEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			return new MobRenderer(renderManager, new Modelcart_titan(), 2f) {
				@Override
	...
	public static class CustomEntity extends MonsterEntity implements IAnimatedEntity {
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				EntityControllableCartTitanOnEntityTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public void onCollideWithPlayer(PlayerEntity sourceentity) {
			...
			double z = this.getPosZ();
			{
				...
				$_dependencies.put("entity", entity);
				$_dependencies.put("sourceentity", sourceentity);
				CartRideProcedure.executeProcedure($_dependencies);
			}
		}
	...
	public static class Modelcart_titan extends EntityModel<Entity> {
		...
		public Modelcart_titan() {
			...
			shouldermomento.setTextureOffset(387, 397).addBox(-7.75F, -26.6736F, -5.0152F, 15.0F, 23.0F, 15.0F, 0.0F, false);
			...
			lshoulderarm.setTextureOffset(510, 162).addBox(-21.5954F, -137.7556F, 10.0327F, 18.0F, 24.0F, 3.0F, 0.0F, false);
			lshoulderarm.setTextureOffset(506, 483).addBox(-21.5954F, -137.7556F, 10.0327F, 18.0F, 24.0F, 3.0F, 0.0F, false);
